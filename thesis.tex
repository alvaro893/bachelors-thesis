...
The Question: How to create a effective communication channel between ir sensors and clients such as computers, laptops, etc?
...
The thesis motivation originates in a project I am doing in collaboration with a startup called Levitezer (\url{http://www.levitezer.com/}) where the methods and software I developed are being used to create an \gls{api} that connect \gls{ir} sensors together.

This is an important project as it is a hot topic in the IT world. The process and method described on this thesis may help others with their \gls{iot} projects.
