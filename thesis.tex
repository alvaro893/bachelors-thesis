...
Streaming serial data (binary) from IR camera using android devices and LTE modules to cloud,
and from cloud to clients that wish to listen the stream (to see ir camera).

\chapter{Theoretical Background}
Usb protocol, serial protocol, streaming, caching, buffering, 

\chapter{Methods and materials}
Android devices, Arduino, LTE module (IoT), IR sensor
Internet: TCP/IP, Http, web Sockets
