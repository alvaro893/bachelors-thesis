...
\begin{document}
\counterwithout{lstlisting}{chapter}
\lstdefinestyle{styleprogramming}{basicstyle=\ttfamily\small\captionsetup{labelformat=empty,labelsep=none}
}
...
\putcode{label_php}{text}[language=PHP,style=styleprogramming,commentstyle=\ttfamily\color{violet}]^
<?php
$data = "";
