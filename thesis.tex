...
\begin{lstlisting}[basicstyle=\ttfamily,caption={AT commands},label=at_commands]
AT^SMSO  # shutdown
...
For a full list of features refer to \url{http://www.gemalto.com/brochures-site/download-site/Documents/M2M_ELS61_datasheet.pdf}

\subsubsection{Gemalto Board}
