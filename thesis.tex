...
Android applications are divided on different screens called Activities which contain \gls{ui} elements that the user can interact. In this case there is an activity for choosing the camera to connect, see figure~\ref{fig:android-client3}.
...
Self-driven public transport vehicles could also benefit from this system, since there is no driver nor any other worker on the vehicle. Accessible remote thermal sensor can give valuable data to a hypothetical station in charge of the security of such vehicles and trigger an alarm in case of any dangerous situation.
    \clearpage
...
\end{itemize}
 ...
 Either LeViteZer and Nokia participants on the project have been quite satisfied with the results and are willing to continue working on this project beyond the scope of this thesis.
 ...
 It was intended to deepen more on the use cases especially on well-being services. But unfortunately there was no time for more research on this. Perhaps other students' thesis projects continue this part.
