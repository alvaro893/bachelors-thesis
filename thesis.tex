...
In order to establish a communication between two ends in a computer network or Internet it is good to comprehend how the "Internet Protocol Architecture" or \gls{tcp}/\gls{ip} stack work, which is the conceptual model which most of networks are based on~\cite[9]{tcpip}.
