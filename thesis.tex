...
Dr. Tero Nurminen, TKI-vastaava yliopettaja \newline
}
...
\newglossaryentry{ws}{
	name=Websocket, 
	description={Application protocol build on top of TCP}
}
\newglossaryentry{github}{
	name=GitHub, 
	description={Hosting site for Git repositories}
}
\newglossaryentry{git}{
	name=Git, 
...
\newglossaryentry{thesis}{
	name=Thesis, 
	description={A final year project report for a university degree},
	plural=Theses
}
...
\begin{tabular}{ | p{4,7cm} | p{10,3cm} |}
 ...
 The objective of this thesis was to develop an effective bidirectional communication system for IR sensors from the company LeViteZer using an IoT approach and connecting them through cloud services and mobile networks provided by the Nokia Innovation Platform.\newline
\newline
...
Please refer to section~\ref{sec:software} in chapter~\ref{sec:results} to obtain the last version of the code created in this project.
