...
This project started with a \gls{ir} sensor provided by Levitezer which delivers all infrared data in form of binary streams trough \gls{usb} as:
...
In 3.1 every byte is seen in hexadecimal format containing an initial sequence "FF FF FF" is the between rows of typically 80 bytes of data. After this initial sequence a number identifies the row.
